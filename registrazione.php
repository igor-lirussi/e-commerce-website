    ...
    <form id="form" name="form" action="register.php" method="post" onsubmit="return false;">
      ...
      <h3>Account</h3>
        ...
        <figure style="float:left;">
          ...
          direttamente in sconti! <br/> Inoltre non dovrai più inserire i tuoi recapiti e i tuoi dati di pagamento,
      ...
      <h3>Indirizzo</h3>
        ...
        <figure style="float:left;">
          ...
          <p>Impostare un indirizzo ti permette di ricevere il nostro cibo proprio sotto casa!
            <br/> Inoltre non dovrai più inserire i tuoi recapiti e ci permetterai di migliorare il servizio.
            <br> La consegna se sei registrato è gratis! </p>
      </fieldset>
