...
--
-- Host: 127.0.0.1
-- Creato il: Gen 28, 2018 alle 14:18
...
(5, 'Pizza margherita', 'Primi', 'Classica pizza margherita con bottiglia d\'acqua da 0.5l', 4, './risorse dei programmatori/immagini cibi/pizza_margherita_figa.jpg'),
(6, 'Pasta al cartoccio', 'Primi', 'Pasta al pomodoro in contenitore ermetico', 3, './risorse dei programmatori/immagini cibi/pasta-cup.jpg'),
(7, 'Acqua naturale 0.5l', 'Bevande', 'Fresca bottiglietta per dissetarsi', 1, './risorse dei programmatori/immagini cibi/acqua_naturale.png'),
(8, 'Coca Cola 50ml', 'Bevande', 'Coca cola in lattina servita fresca', 2.5, './risorse dei programmatori/immagini cibi/cocacola_lattina_33cl.jpg');
